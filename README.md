...
This is a .NET 10 WinForms application that demonstrates features of the [CP-IO13-4C](https://comfiletech.com/raspberry-pi-panel-pc/cp-io13-4c-i-o-board-accessory-for-cpi-c-series/) IO board for the [ComfilePi industrial touchscreen panel PCs](https://comfiletech.com/linux-panel-pc/), and how to program it.
...
1. Right-click the `ComfileTech.ComfilePi.CP_IO13_4C.Demo` project and choose **Publish**.
